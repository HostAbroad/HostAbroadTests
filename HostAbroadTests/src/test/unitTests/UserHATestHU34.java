...
public class UserHATestHU34 {
	...
	public void test() {
		...
		*/
		...
		assertEquals(user1.getLikes(), likes);
		assertEquals(user1.getHostEntity(), null);
		assertEquals(user2.getLikes(), likes);
		assertEquals(user2.getHostEntity(), host2);
		assertEquals(user2.getTravelerEntity(), null);
		assertEquals(user2.getRates(), rates);
		assertEquals(user2.calculateRating(), 4, 2);
	}
